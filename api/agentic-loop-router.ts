...
export const agenticLoopRouter = createRouter({
  ...
  capabilities: protectedQuery.query(async () => ({
    ...
    actions: ["campaign_pause", "campaign_resume", "video_produce", "video_retry", "daily_run", "ops_redeploy", "campaign_create", "creative_create", "publication_create", "publication_publish", "scheduled_post_create", "record_create", "record_update", "engine_run"],
